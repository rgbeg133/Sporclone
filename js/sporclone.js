...
function start()
{
    if (!playing)
    {
        ...
        // q.
        document.getElementById('time').style.color = "#49FF00";
...
function end()
{
    ...
    for (var i=0; i<is_guessed.length; i++)
    {
        ...
        {
         document.getElementById(id).style.backgroundColor = "#49FF00";
        }
        else
        {
          document.getElementById(id).style.backgroundColor = "#F44A59";
        }
